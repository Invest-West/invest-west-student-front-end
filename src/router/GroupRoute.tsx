...
> {
  ...
  componentDidUpdate(
    ...
    if (
      ...
      // Don't redirect admin routes to 404 - let auth handle it
      ...
      (isInvestWestRoute || isProtectedAdminRoute) &&
      !successfullyValidatedGroupUrl(this.props.ManageGroupUrlState)
    ) {
      console.log(
        '[ROUTING DEBUG] invest-west or admin route detected but validation pending, allowing through'
      );
    }
