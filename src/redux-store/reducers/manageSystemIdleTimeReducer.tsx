import {
  ManageSystemIdleTimeAction,
  ManageSystemIdleTimeEvents,
} from '../actions/manageSystemIdleTimeActions';
...
const manageSystemIdleTimeReducer = (
  state = initialState,
  action: ManageSystemIdleTimeAction | AuthenticationAction
) => {
  switch (action.type) {
