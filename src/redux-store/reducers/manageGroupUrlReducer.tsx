...
const manageGroupUrlReducer = (
  state: ManageGroupUrlState = initialState,
  action: ManageGroupUrlAction
) => {
  switch (action.type) {
    ...
    case ManageGroupUrlEvents.FinishedValidatingGroupUrl:
      const finishedValidatingGroupUrlAction: FinishedValidatingGroupUrlAction =
        action as FinishedValidatingGroupUrlAction;
      return {
        ...state,
        group:
          finishedValidatingGroupUrlAction.group === null
            ? null
            : JSON.parse(JSON.stringify(action.group)),
        groupLoaded: true,
        loadingGroup: false,
