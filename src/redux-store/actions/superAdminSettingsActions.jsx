...
export const SUPER_ADMIN_SETTINGS_INITIALIZE_CLUB_ATTRIBUTES_EDITED =
  'SUPER_ADMIN_SETTINGS_INITIALIZE_CLUB_ATTRIBUTES_EDITED';
...
export const SUPER_ADMIN_SETTINGS_QUILL_EDITOR_CHANGED =
  'SUPER_ADMIN_SETTINGS_QUILL_EDITOR_CHANGED';
...
export const SUPER_ADMIN_SETTINGS_PLEDGE_FAQ_PANEL_EXPANSION_CHANGED =
  'SUPER_ADMIN_SETTINGS_PLEDGE_FAQ_PANEL_EXPANSION_CHANGED';
...
export const SUPER_ADMIN_SETTINGS_TOGGLE_EDIT_EXPANDED_PLEDGE_FAQ =
  'SUPER_ADMIN_SETTINGS_TOGGLE_EDIT_EXPANDED_PLEDGE_FAQ';
...
export const SUPER_ADMIN_SETTINGS_TOGGLE_ADD_NEW_PLEDGE_FAQ =
  'SUPER_ADMIN_SETTINGS_TOGGLE_ADD_NEW_PLEDGE_FAQ';
...
export const submitNewPledgeFAQ = () => {
  return (dispatch, getState) => {
    const { addedPledgeQuestion, addedPledgeAnswer } = getState().superAdminSettings;
...
export const saveEditedPledgeFAQ = () => {
  return (dispatch, getState) => {
    const { clubAttributesEdited, expandedPledgeFAQ, editedPledgeQuestion, editedPledgeAnswer } =
    ...
    const index = clubAttributesEdited[DB_CONST.PLEDGE_FAQS_CHILD].findIndex(
...
export const deleteExistingPledgeFAQ = () => {
  return (dispatch, getState) => {
    const expandedPledgeFAQ = getState().superAdminSettings.expandedPledgeFAQ;
    const clubAttributesEdited = Object.assign(
      {},
      getState().manageClubAttributes.clubAttributesEdited
    );
