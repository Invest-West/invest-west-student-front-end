...
export const INVESTOR_SELF_CERTIFICATION_AGREEMENT_SET_USER =
  'INVESTOR_SELF_CERTIFICATION_AGREEMENT_SET_USER';
...
export const LOADING_INVESTOR_SELF_CERTIFICATION_AGREEMENT =
  'LOADING_INVESTOR_SELF_CERTIFICATION_AGREEMENT';
export const FINISHED_LOADING_INVESTOR_SELF_CERTIFICATION_AGREEMENT =
  'FINISHED_LOADING_INVESTOR_SELF_CERTIFICATION_AGREEMENT';
export const loadInvestorSelfCertificationAgreement = () => {
  return (dispatch, getState) => {
    const { userID } = getState().manageInvestorSelfCertificationAgreement;
...
export const INVESTOR_SELF_CERTIFICATION_AGREEMENT_TICK_BOX_CHANGED =
  'INVESTOR_SELF_CERTIFICATION_AGREEMENT_TICK_BOX_CHANGED';
...
export const UPDATE_INVESTOR_SELF_CERTIFICATION_AGREEMENT =
  'UPDATE_INVESTOR_SELF_CERTIFICATION_AGREEMENT';
export const setInvestorSelfCertificationAgreement = () => {
  return (dispatch, getState) => {
    const { userID, statementType } = getState().manageInvestorSelfCertificationAgreement;
...
export const INVESTOR_SELF_CERTIFICATION_AGREEMENT_STATEMENT_TYPE_CHANGED =
  'INVESTOR_SELF_CERTIFICATION_AGREEMENT_STATEMENT_TYPE_CHANGED';
