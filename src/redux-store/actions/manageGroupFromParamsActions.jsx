...
export const SET_EXPECTED_AND_CURRENT_PATHS_FOR_CHECKING =
  'SET_EXPECTED_AND_CURRENT_PATHS_FOR_CHECKING';
...
export const startListeningForAngelNetworkChanged = () => {
  return (dispatch, getState) => {
    if (!angelNetworkListener) {
      const { groupProperties } = getState().manageGroupFromParams;
