...
export const GROUP_ADMIN_SETTINGS_INITIALIZE_GROUP_ATTRIBUTES_EDITED =
  'GROUP_ADMIN_SETTINGS_INITIALIZE_GROUP_ATTRIBUTES_EDITED';
...
export const handleCancelEditingPitchExpiryDate = () => {
  return (dispatch, getState) => {
    ...
    dispatch({
      ...
      isPropertyOfGroupAttributes: true,
      name: 'defaultPitchExpiryDate',
      value: !groupProperties.settings.hasOwnProperty('defaultPitchExpiryDate')
...
export const GROUP_ADMIN_SETTINGS_PLEDGE_FAQ_PANEL_EXPANSION_CHANGED =
...
export const GROUP_ADMIN_SETTINGS_TOGGLE_EDIT_EXPANDED_PLEDGE_FAQ =
  'GROUP_ADMIN_SETTINGS_TOGGLE_EDIT_EXPANDED_PLEDGE_FAQ';
...
export const GROUP_ADMIN_SETTINGS_TOGGLE_ADD_NEW_PLEDGE_FAQ =
  'GROUP_ADMIN_SETTINGS_TOGGLE_ADD_NEW_PLEDGE_FAQ';
...
export const submitNewPledgeFAQ = () => {
  return (dispatch, getState) => {
    const { addedPledgeQuestion, addedPledgeAnswer } = getState().groupAdminSettings;

    const groupProperties = getState().manageGroupFromParams.groupProperties;

    const groupAttributesEdited = Object.assign(
      {},
      getState().groupAdminSettings.groupAttributesEdited
    );
...
export const saveEditedPledgeFAQ = () => {
  return (dispatch, getState) => {
    const { groupAttributesEdited, expandedPledgeFAQ, editedPledgeQuestion, editedPledgeAnswer } =
    ...
    const index = groupAttributesEdited[DB_CONST.PLEDGE_FAQS_CHILD].findIndex(
      (faq) => faq.id === expandedPledgeFAQ.id
    );
...
export const GROUP_ADMIN_SETTINGS_CANCEL_EDITING_GROUP_DETAILS =
  'GROUP_ADMIN_SETTINGS_CANCEL_EDITING_GROUP_DETAILS';
...
export const saveColor = (field) => {
  return (dispatch, getState) => {
    ...
    const color =
      field === 'primaryColor'
        ? getState().groupAdminSettings.primaryColor
        : getState().groupAdminSettings.secondaryColor;
...
export const GROUP_ADMIN_SETTINGS_CANCEL_EDITING_COLOR =
  'GROUP_ADMIN_SETTINGS_CANCEL_EDITING_COLOR';
export const cancelEditingColor = (field) => {
  return (dispatch, getState) => {
    const group = getState().manageGroupFromParams.groupProperties;
    const color =
      field === 'primaryColor' ? group.settings.primaryColor : group.settings.secondaryColor;
...
export const GROUP_ADMIN_SETTINGS_QUILL_EDITOR_CHANGED =
  'GROUP_ADMIN_SETTINGS_QUILL_EDITOR_CHANGED';
