...
export const CREATE_PLEDGE_DIALOG_HANDLE_INPUT_CHANGED =
  'CREATE_PLEDGE_DIALOG_HANDLE_INPUT_CHANGED';
...
export const CREATE_PLEDGE_DIALOG_CREATE_STATUS_CHANGED =
  'CREATE_PLEDGE_DIALOG_CREATE_STATUS_CHANGED';
export const createPledge = () => {
  return (dispatch, getState) => {
    const { project, postMoneyValuation, expiredDate, extraNotes } =
    ...
    const projectVisibilitySetting =
      getState().manageSelectProjectVisibility.projectVisibilitySetting;
    ...
    if (expiredDate === null) {
      ...
      if (
        project.issuer.type === DB_CONST.TYPE_ISSUER &&
      ...
      updatedProject.visibility =
        projectVisibilitySetting === -1
          ? projectBeforeUpdating.visibility
      ...
      firebase
        ...
        .then(() => {
          ...
          realtimeDBUtils.trackActivity({
            ...
            activitySummary: realtimeDBUtils.ACTIVITY_SUMMARY_TEMPLATE_CREATED_PLEDGE.replace(
              '%project%',
