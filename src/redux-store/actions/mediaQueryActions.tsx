...
export const removeMediaQueryListeners: ActionCreator<any> = () => {
  return (dispatch: Dispatch, getState: () => AppState) => {
    mobileScreen.removeEventListener('change', () => listener(null, null, null));

    tabletScreen.removeEventListener('change', () => listener(null, null, null));

    laptopScreen.removeEventListener('change', () => listener(null, null, null));

    desktopScreen.removeEventListener('change', () => listener(null, null, null));

    minHeightScreen.removeEventListener('change', () => listener(null, null, null));
  };
};
