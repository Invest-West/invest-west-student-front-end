...
export const sendInvitation = () => {
  return (dispatch, getState) => {
    ...
    const { title, firstName, lastName, email, userType } = getState().manageInvitationDialog;
    ...
    realtimeDBUtils
      ...
      .then((angelNetworksInvitedUser) => {
        ...
        for (const angelNetworkInvitedUser of angelNetworksInvitedUser) {
          ...
          if (
            angelNetworkInvitedUser.Invitee.type === DB_CONST.TYPE_ISSUER &&
            angelNetworkInvitedUser.Invitor.anid !== groupProperties.anid
          ) {
        ...
        if (!invitedBefore) {
          ...
          realtimeDBUtils
            ...
            .then((result) => {
              ...
              if (
                result.userExists &&
                result.hasOwnProperty('userIsAnAdmin') &&
                result.userIsAnAdmin
              ) {
                dispatch({
                  type: INVITATION_DIALOG_SEND_RESULT_CHANGED,
                  result: SEND_INVITATION_USER_CANNOT_BE_INVITED,
              ...
              const invitedID = firebase.database().ref(DB_CONST.INVITED_USERS_CHILD).push().key;
              ...
              emailUtils
                .sendEmail({
                  ...
                  data: {
                    ...
                    groupLogo: myUtils.getLogoFromGroup(myUtils.GET_PLAIN_LOGO, groupProperties),
                  ...
                  firebase
                    ...
                    .then(() => {
                      ...
                      realtimeDBUtils.trackActivity({
                        ...
                        activitySummary:
                          realtimeDBUtils.ACTIVITY_SUMMARY_TEMPLATE_SENT_A_USER_INVITATION.replace(
                            '%userName%',
                        ...
                        action: ROUTES.USER_PROFILE_INVEST_WEST_SUPER.replace(
                          ':userID',
                          invitedUser.id
                        ),
                        value: invitedUser,
