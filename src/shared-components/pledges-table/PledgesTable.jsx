...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    handlePledgesTableInputChanged: (event) =>
      dispatch(pledgesTableActions.handlePledgesTableInputChanged(event)),
    startListeningForPledgesChanged: () =>
      dispatch(pledgesTableActions.startListeningForPledgesChanged()),
    ...
    return (
      <Paper elevation={1} style={{ width: '100%', overflowX: 'auto', marginTop: 20 }}>
        <Table>
          ...
          <TableBody>{this.renderPledgesRows()}</TableBody>
          <TableFooter>
            <TableRow>
              <TablePagination
        ...
        <TableRow key={pledge.id} hover>
          <TableCell colSpan={2}>
            <FlexView column>
              ...
              utils.getUserHomeGroup(pledge.groupsInvestorIsIn).groupDetails.settings
                ...
                >
                  <Typography
                    ...
                    variant="body2"
                    color="primary"
                  >{`${pledge.investor.title} ${pledge.investor.firstName} ${pledge.investor.lastName}`}</Typography>
                </NavLink>
              ) : (
