...
export default class ReactQuillSizingExamples extends Component {
  ...
  render() {
    const { smallContent, mediumContent, largeContent, customContent, responsiveContent } =
      this.state;
      ...
      <FlexView column style={{ padding: 20, maxWidth: 1200, margin: '0 auto' }}>
        ...
        <Paper elevation={2} style={{ padding: 20, backgroundColor: '#f5f5f5' }}>
          ...
          <ul style={{ marginLeft: 20, color: '#666' }}>
            <li>
              <strong>Use CSS classes</strong> for consistent sizing across your app
            </li>
            <li>
              <strong>Set min-height</strong> instead of fixed height for flexibility
            </li>
            <li>
              <strong>Add overflow-y: auto</strong> for scrollable content when needed
            </li>
            <li>
              <strong>Use responsive design</strong> for different screen sizes
            </li>
            <li>
              <strong>Adjust toolbar size</strong> for compact editors
            </li>
            <li>
              <strong>Import the CSS</strong> file in your main component or App.js
            </li>
          </ul>
        </Paper>
      </FlexView>
