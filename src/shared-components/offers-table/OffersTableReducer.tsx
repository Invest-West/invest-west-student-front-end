  ...
  switch (action.type) {
    ...
    case OffersTableEvents.SetTableUser:
      ...
      return {
        ...initialState,
        tableUser:
          setTableUserAction.user !== undefined
            ? JSON.parse(JSON.stringify(setTableUserAction.user))
            : undefined,
        tableUserGroupsOfMembership:
          setTableUserAction.groupsOfMembership !== undefined
            ? [...setTableUserAction.groupsOfMembership]
            : undefined,
        groupsSelect:
          setTableUserAction.groupsSelect !== undefined
            ? [...setTableUserAction.groupsSelect]
            : undefined,
        error:
          setTableUserAction.error !== undefined
            ? { detail: setTableUserAction.error }
            : state.error,
      };
    ...
    case OffersTableEvents.CompleteFetchingOffers:
      const completeFetchingOffersAction: CompleteFetchingOffersAction =
        action as CompleteFetchingOffersAction;
      return {
        ...state,
        ...
        currentPage: 0,
        error:
          completeFetchingOffersAction.error !== undefined
            ? { detail: completeFetchingOffersAction.error }
            : state.error,
      };
    ...
    case OffersTableEvents.CompleteExportingCsv:
      const completeExportingCsvAction: CompleteExportingCsvAction =
        action as CompleteExportingCsvAction;
      return {
        ...state,
        exportingCsv: false,
        errorExportingCsv:
          completeExportingCsvAction.error !== undefined
            ? { detail: completeExportingCsvAction.error }
            : state.errorExportingCsv,
      };
    ...
    case OffersTableEvents.CompleteFetchingFeedbackCount:
      const completeFetchingFeedbackCountAction: CompleteFetchingFeedbackCountAction =
        action as CompleteFetchingFeedbackCountAction;
      return {
        ...state,
        fetchingFeedbackCount: false,
