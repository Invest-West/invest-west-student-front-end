import {
  FeedbackSnackbarAction,
  FeedbackSnackbarEvents,
  OpenFeedbackSnackbarAction,
} from './FeedbackSnackbarActions';
...
const feedbackSnackbarReducerNew = (state = initialState, action: FeedbackSnackbarAction) => {
  switch (action.type) {
    case FeedbackSnackbarEvents.Open:
      const openFeedbackSnackbarAction: OpenFeedbackSnackbarAction =
        action as OpenFeedbackSnackbarAction;
      return {
        ...state,
        open: true,
