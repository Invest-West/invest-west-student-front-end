        ...
        <Row noGutters>
          <Col xs={12} sm={12} md={12} lg={12} style={{ padding: 24 }}>
            <FlexView column>
              ...
              >
                Update your password regularly to protect your account better. Password must contain
              ...
              <TextField
                ...
                margin="normal"
                variant="outlined"
                error={passwordChangeResponseCode === PASSWORD_CHANGE_NOT_MATCH_WITH_VERIFIED}
                onChange={handleTextChanged}
              />
...
class PasswordUpdate extends Component {
  ...
  render() {
    ...
    return responseCode === PASSWORD_CHANGE_NONE ? null : (
      <FlexView
        grow={1}
        style={{ backgroundColor: this.renderMessage().color }}
