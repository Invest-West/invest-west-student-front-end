...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    handleQuillChanged: (field, editor) =>
      dispatch(forumsActions.handleQuillChanged(field, editor)),
  };
};
        ...
        <Col xs={12} sm={12} md={12} lg={12}>
          <FlexView column>
            <Typography paragraph variant="h6" color="primary">
              {threadEdited ? 'Edit thread' : 'Create thread'}
            </Typography>
            {threadEdited ? null : (
              <Typography paragraph variant="body1" color="textSecondary" align="left">
                A thread is a series of posts related to the same subject. Threads provide an
                organisational structure within a forum for users to share posts on similar topics.
                Creating a thread posts the first message.
              </Typography>
            )}
