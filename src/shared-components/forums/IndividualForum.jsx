...
const mapDispatchToProps = (dispatch) => {
  return {
    toggleCreateNewThread: (open, threadEdited) =>
      dispatch(forumsActions.toggleCreateNewThread(open, threadEdited)),
...
class IndividualForum extends Component {
  ...
  renderThreads = () => {
    ...
    return sortedThreads
      .slice(
        threadsTablePage * threadsTableRowsPerPage,
        threadsTablePage * threadsTableRowsPerPage + threadsTableRowsPerPage
      )
      .map((thread) => (
      ...
      <FlexView column>
                  ...
                  <Paper>
                    <FormControl fullWidth>
                      <Select
                        ...
                        margin="dense"
                        input={<OutlinedInput labelWidth={0} name="threadsLoadMode" />}
                      >
                        <MenuItem value={realtimeDBUtils.LOAD_LIVE_THREADS}>Live threads</MenuItem>
                        <MenuItem value={realtimeDBUtils.LOAD_DELETED_THREADS}>
                          Deleted threads
                        </MenuItem>
                      </Select>
                    </FormControl>
                ...
                <Paper>
                  <FormControl fullWidth>
                    <Select
                      ...
                      onChange={handleForumsInputChanged}
                      margin="dense"
                      input={<OutlinedInput labelWidth={0} name="threadsSortedMode" />}
                    >
        ...
        <Paper style={{ overflowX: 'auto' }}>
          <Table>
            ...
            <TableBody>{this.renderThreads()}</TableBody>
            <TableFooter>
              <TableRow>
                <TablePagination
                  style={{
