...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    startListeningForThreadsChanged: () =>
      dispatch(forumsActions.startListeningForThreadsChanged()),
    ...
    startListeningForThreadRepliesChanged: () =>
      dispatch(forumsActions.startListeningForThreadRepliesChanged()),
    stopListeningForThreadRepliesChanged: () =>
      dispatch(forumsActions.stopListeningForThreadRepliesChanged()),

    toggleCreateNewForum: (open, forumEdited) =>
      dispatch(forumsActions.toggleCreateNewForum(open, forumEdited)),
    ...
    tableChangeRowsPerPage: (table, event) =>
      dispatch(forumsActions.changeRowsPerPage(table, event)),
  };
};
...
class Forums extends Component {
  ...
  renderContent = () => {
    ...
    switch (modeForums) {
        ...
        return (
          <FlexView column>
            <Typography variant="body2" color="textSecondary" align="left">
              ...
              particular subject. Create forums to organise discussions.
              <br />
                      ...
                      <Paper>
                        <FormControl fullWidth>
                          <Select
                            ...
                            margin="dense"
                            input={<OutlinedInput labelWidth={0} name="forumsLoadMode" />}
                          >
                            <MenuItem value={realtimeDBUtils.LOAD_LIVE_FORUMS}>
                              Live forums
                            </MenuItem>
                            <MenuItem value={realtimeDBUtils.LOAD_DELETED_FORUMS}>
                              Deleted forums
                            </MenuItem>
                          </Select>
                        </FormControl>
                    ...
                    <Paper>
                      <FormControl fullWidth>
                        <Select
                          ...
                          onChange={handleForumsInputChanged}
                          margin="dense"
                          input={<OutlinedInput labelWidth={0} name="forumsSortedMode" />}
                        >
            ...
            <Paper style={{ overflowX: 'auto' }}>
              <Table>
                ...
                <TableBody>{this.renderForums()}</TableBody>
                <TableFooter>
                  <TableRow>
                    <TablePagination
                      style={{
      ...
      case MODE_VIEW_FORUM:
        return <IndividualForum />;

      case MODE_CREATE_THREAD:
        return <CreateThread />;

      case MODE_VIEW_THREAD:
        return <IndividualThread />;
  ...
  renderForums = () => {
    ...
    return sortedForums
      .slice(
        forumsTablePage * forumsTableRowsPerPage,
        forumsTablePage * forumsTableRowsPerPage + forumsTableRowsPerPage
      )
      .map((forum) => (
        <ForumRow
   ...
   */
  render() {
    const { groupPropertiesLoaded } = this.props;
        ...
        <TableCell style={{ maxWidth: 400 }}>
          <FlexView column hAlignContent="left">
            <ButtonBase onClick={() => this.onForumClick(forum)}>
              <Typography align="left" variant="body2" color="primary" noWrap>
                {forum.name}
              </Typography>
            </ButtonBase>
