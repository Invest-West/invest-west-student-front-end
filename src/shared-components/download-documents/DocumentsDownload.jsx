...
export default class DocumentsDownload extends Component {
  ...
  render() {
     ...
     * }
     */
    const { documents, deleteEnable } = this.props;
      ...
      <FlexView column marginTop={20}>
        <List>
          {documents.map((document, index) =>
            document.hasOwnProperty('removed') ? null : (
              <FlexView key={index} vAlignContent="center">
                  ...
                  >
                    ...
                    >
                      {(() => {
                        ...
                        return (
                          <IconComponent
                            style={{ color: fileInfo.color, fontSize: 40, marginRight: 8 }}
                          />
                        );
                      })()}
                      <FlexView column hAlignContent="left">
                        <Typography variant="body2" className={css(styles.black_text)} align="left">
                          {document.fileName}
                        </Typography>
                ...
                {deleteEnable ? (
                  <OverlayTrigger
                    ...
                    flip
                    placement="top"
                    overlay={<Tooltip id={`tooltip-top`}>Delete this document</Tooltip>}
                  >
                    <IconButton
