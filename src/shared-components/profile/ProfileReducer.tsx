  ...
  switch (action.type) {
    case ProfileEvents.SetCopiedUser:
      ...
      return {
        ...
        hasInitiallySetCopiedUser:
          setCopiedUserAction.firstTimeSetCopiedUser === true
            ? true
            : state.hasInitiallySetCopiedUser,
      };
    ...
    case EditImageDialogEvents.SuccessfullySelectedImage:
      const successfullySelectedImageAction: SuccessfullySelectedImageAction =
        action as SuccessfullySelectedImageAction;
      return {
        ...state,
        EditImageDialogState: {
          ...state.EditImageDialogState,
    ...
    case BusinessProfileEvents.CheckBoxChanged:
      const businessProfileCheckBoxChangedAction: BusinessProfileCheckBoxChangedAction =
        action as BusinessProfileCheckBoxChangedAction;
      return {
        ...state,
        BusinessProfileState: {
          ...state.BusinessProfileState,
