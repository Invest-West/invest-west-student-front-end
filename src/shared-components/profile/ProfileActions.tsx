...
export const setCopiedUser: ActionCreator<any> = (
  user: User | null,
  firstTimeSetCopiedUser?: true
) => {
...
export const handleInputFieldChanged: ActionCreator<any> = (
  ...
  return (dispatch: Dispatch, getState: () => AppState) => {
    const currentCopiedUser: User | undefined = JSON.parse(
      JSON.stringify(getState().ProfileLocalState.copiedUser)
    );
