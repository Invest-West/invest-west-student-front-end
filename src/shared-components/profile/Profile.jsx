...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    handleCreateBusinessProfileTextChanged: (fieldType, event) =>
      dispatch(createBusinessProfileActions.handleTextChanged(fieldType, event)),
    toggleEnterAddressManually: (field) =>
      dispatch(createBusinessProfileActions.toggleEnterAddressManually(field)),
    ...
    toggleExpandBusinessProfileFillingForInvestor: () =>
      dispatch(createBusinessProfileActions.toggleExpandBusinessProfileFillingForInvestor()),
    ...
    addNewDirectorTemporarily: (isEditingExistingBusinessProfile) =>
      dispatch(editUserActions.addNewDirectorTemporarily(isEditingExistingBusinessProfile)),
    deleteDirectorTemporarily: (index, isEditingExistingBusinessProfile) =>
      dispatch(editUserActions.deleteDirectorTemporarily(index, isEditingExistingBusinessProfile)),
    ...
    startListeningForLegalDocumentsChanged: () =>
      dispatch(legalDocumentsActions.startListeningForLegalDocumentsChanged()),
    stopListeningForLegalDocumentsChanged: () =>
      dispatch(legalDocumentsActions.stopListeningForLegalDocumentsChanged()),
    //--------------------------------------------------------------------------------------------------------------

    // Upload documents functions ----------------------------------------------------------------------------------
    handleFilesChanged: (mode, files, user, project) =>
      dispatch(uploadFilesActions.handleFilesChanged(mode, files, user, project)),
    ...
    resetErrorMessageWhenFileUploadSnackbarExited: () =>
      dispatch(uploadFilesActions.resetErrorMessageWhenSnackbarExited()),
    deleteToBeUploadedFile: (mode, index) =>
      dispatch(uploadFilesActions.deleteToBeUploadedFile(mode, index)),
    deleteUploadedFile: (mode, index, user, project) =>
      dispatch(uploadFilesActions.deleteUploadedFile(mode, index, user, project)),
    uploadFiles: (mode, user, project) =>
      dispatch(uploadFilesActions.uploadFiles(mode, user, project)),
    //--------------------------------------------------------------------------------------------------------------
...
class Profile extends Component {
  ...
  componentWillUnmount() {
    const { stopListeningForLegalDocumentsChanged } = this.props;
  ...
  render() {
    ...
    return (
      <Container fluid style={{ padding: 0 }}>
              ...
              <Row noGutters style={{ marginTop: 20 }}>
                ...
                <Col xs={12} sm={12} md={6} lg={4}>
                  <FlexView column hAlignContent="center" style={{ padding: 10 }}>
                    ...
                    (originalUser.profilePicture &&
                      originalUser.profilePicture.findIndex(
                        (profilePicture) => !profilePicture.hasOwnProperty('removed')
                      ) === -1) ? (
                      <LetterAvatar
                    ...
                    {currentUser.type === DB_CONST.TYPE_ADMIN ? null : (
                      <FlexView marginTop={20} marginBottom={20}>
                        <Button
                          ...
                          color="primary"
                          onClick={() =>
                            this.props.toggleEditImageDialog(UPLOAD_PROFILE_PICTURE_MODE)
                          }
                          style={{ width: 256 }}
                        >
                ...
                <Col xs={12} sm={12} md={6} lg={8}>
                  <Row>
                    ...
                    >
                      <FormControl variant="standard" fullWidth>
                        ...
                        <TextField
                          ...
                          variant="outlined"
                          onChange={this.handleEditUser(editUserActions.EDIT_PERSONAL_INFORMATION)}
                          error={userEdited.firstName && userEdited.firstName.trim().length === 0}
                        />
                      </FormControl>
                    </Col>
                    ...
                    >
                      <FormControl variant="standard" fullWidth>
                        ...
                        <TextField
                          ...
                          variant="outlined"
                          onChange={this.handleEditUser(editUserActions.EDIT_PERSONAL_INFORMATION)}
                          error={userEdited.lastName && userEdited.lastName.trim().length === 0}
                        />
                      </FormControl>
                    </Col>
                    ...
                    >
                      ...
                      {!userEdited.linkedin ||
                      utils.isValidLinkedInURL(userEdited.linkedin) ? null : (
                        <FormHelperText className={css(sharedStyles.error_text)}>
                          ...
                          <FormControl variant="standard" fullWidth>
                            ...
                            <TextField
                              ...
                              onChange={this.handleEditUser(
                                editUserActions.EDIT_PERSONAL_INFORMATION
                              )}
                            />
                          </FormControl>
                        </Col>
                        ...
                        >
                          <FormControl variant="standard" fullWidth>
                            ...
                            <TextField
                              ...
                              value={
                                userEdited.hasOwnProperty('companyName')
                        ...
                        >
                          <FormControl variant="standard" fullWidth>
                            ...
                            <TextField
                              ...
                              value={
                                userEdited.hasOwnProperty('description')
                  ...
                  <FlexView hAlignContent="right" marginTop={30}>
                    <FlexView marginRight={20}>
                      <Button
                        ...
                        color="primary"
                        onClick={() =>
                          this.props.cancelEditingUser(editUserActions.RESET_PERSONAL_INFORMATION)
                        }
                      >
                        Cancel
                      </Button>
                          ...
                          (userEdited.title === originalUser.title &&
                            ...
                            ((originalUser.linkedin &&
                              ...
                              (userEdited.linkedin &&
                                originalUser.linkedin &&
                                !utils.isValidLinkedInURL(userEdited.linkedin))) &&
                            (userEdited.company === originalUser.company ||
                              (!userEdited.company && !originalUser.company)) &&
                            (userEdited.companyName === originalUser.companyName ||
                              (!userEdited.companyName && !originalUser.companyName)) &&
                            (userEdited.description === originalUser.description ||
                              (!userEdited.description && !originalUser.description)))
                        }
                        onClick={() =>
                          this.props.commitUserProfileChanges(
                            editUserActions.COMMIT_PERSONAL_INFORMATION_CHANGES
                          )
                        }
                      >
                        Save
                  ...
                  !allowEditing ? (
                    <Typography
                      ...
                      style={{ marginTop: 25 }}
                    >
                      This student is not a home member of your course. So, you cannot edit their
                      profile.
                    </Typography>
                  ) : null}
                </Col>
        ...
        {currentUser.type !== DB_CONST.TYPE_ADMIN ? null : (
          <Row noGutters style={{ backgroundColor: colors.kick_starter_background_color_1 }}>
            {originalUser.type !== DB_CONST.TYPE_ISSUER ? null : (
              <Col xs={12} md={12} lg={12} style={{ padding: 24 }}>
                <FlexView column>
                  <Typography variant="h6" color="primary">
                    Fundraising summary
            ...
            <Col xs={12} sm={12} md={6} lg={4} style={{ padding: 10, width: '100%' }}>
              <FlexView column hAlignContent="center">
                <FlexView column width="100%" hAlignContent="center">
                  ...
                  (originalUser.BusinessProfile.hasOwnProperty('logo') &&
                    originalUser.BusinessProfile.logo.findIndex(
                      (logoItem) => !logoItem.hasOwnProperty('removed')
                    ) === -1) ? (
                    ...
                    <FlexView width={256} height={256}>
                      <Image
                        ...
                        thumbnail
                        src={
                          originalUser.BusinessProfile.logo[
                            originalUser.BusinessProfile.logo.findIndex(
                              (logoItem) => !logoItem.hasOwnProperty('removed')
                            )
                          ].url
                ...
                >
                  ...
                  (originalUser.BusinessProfile.hasOwnProperty('video') &&
                    originalUser.BusinessProfile.video.findIndex(
                      (videoItem) => !videoItem.hasOwnProperty('removed')
                    ) === -1) ? (
                    <Typography align="center" color="textSecondary" variant="body1">
                      {currentUser.type !== DB_CONST.TYPE_ADMIN
            ...
            <Col xs={12} sm={12} md={6} lg={8}>
              ...
              <FlexView column>
                <FormControl variant="standard">
                  ...
                  <TextField
                    ...
                    value={
                      userEdited.BusinessProfile.hasOwnProperty('companyName')
                        ? userEdited.BusinessProfile.companyName
                        : ''
                    }
                    margin="dense"
                    variant="outlined"
                    fullWidth
                    onChange={this.handleEditUser(
                      editUserActions.EDIT_ORDINARY_BUSINESS_PROFILE_INFORMATION
                    )}
                    error={
                      userEdited.BusinessProfile.hasOwnProperty('companyName') &&
                      userEdited.BusinessProfile.companyName &&
                      userEdited.BusinessProfile.companyName.trim().length === 0
                    }
                  />
                </FormControl>
              </FlexView>
              ...
              <FlexView column>
                ...
                (userEdited.BusinessProfile.hasOwnProperty('companyWebsite') &&
                  userEdited.BusinessProfile.companyWebsite &&
                  userEdited.BusinessProfile.companyWebsite.trim().length > 0 &&
                  utils.isValidWebURL(userEdited.BusinessProfile.companyWebsite)) ? null : (
              ...
              <FlexView hAlignContent="right" marginTop={30}>
                <FlexView marginRight={20}>
                  <Button
                    ...
                    color="primary"
                    onClick={() =>
                      this.props.cancelEditingUser(editUserActions.RESET_BUSINESS_PROFILE)
                    }
                  >
                    Cancel
                  </Button>
                  ...
                  <Button
                    ...
                    disabled={
                      ...
                      (userEdited.BusinessProfile.hasOwnProperty('companyWebsite') &&
                        ...
                        userEdited.BusinessProfile.companyWebsite.trim().length > 0 &&
                        !utils.isValidWebURL(userEdited.BusinessProfile.companyWebsite)) ||
                      JSON.stringify(originalUser.BusinessProfile) ===
                        JSON.stringify(userEdited.BusinessProfile)
                    }
                    onClick={() =>
                      this.props.commitUserProfileChanges(
                        editUserActions.COMMIT_BUSINESS_PROFILE_CHANGES
                      )
                    }
                  >
                    Save
              ...
              !currentUser.superAdmin &&
              !allowEditing ? (
                <Typography variant="body1" color="error" align="right" style={{ marginTop: 25 }}>
                  This user is not a home member of your course. So, you cannot edit their profile.
                </Typography>
              ) : null}
            </Col>
          </Row>
              ...
              <FlexView column marginTop={20}>
                ...
                <FlexView column>
                  <FormControl variant="standard" required>
                    ...
                    <TextField
                      ...
                      variant="outlined"
                      margin="dense"
                      onChange={this.handleCreateBusinessProfileTextChanged(
                        createBusinessProfileActions.ORDINARY_BUSINESS_PROFILE_FIELDS_CHANGED
                      )}
                    />
                  </FormControl>
                </FlexView>
                ...
                <FlexView column>
                  <FormControl variant="standard" required>
                    ...
                    />
                    {!createBusinessProfile.BusinessProfile.companyWebsite ||
                    ...
                    <Col xs={12} sm={12} md={6} lg={6} style={{ padding: 15 }}>
                      <FlexView column width="100%" hAlignContent="center">
                        <FlexView
                          ...
                          onClick={() =>
                            this.props.toggleEditImageDialog(UPLOAD_LOGO_FIRST_TIME_MODE)
                          }
                        >
                          <Typography variant="body2" align="center">
                            Upload course logo (optional)
                          </Typography>
                        </FlexView>
                        {!createBusinessProfile.logoToBeUploaded ? null : (
                          <FlexView width={270} height={270} marginTop={28}>
                            <Image
                              ...
                              roundedCircle
                              thumbnail
                              style={{ maxHeight: 270, width: '100%', objectFit: 'scale-down' }}
                            />
                          </FlexView>
                        )}
                      </FlexView>
                      ...
                      <FlexView column width="100%" hAlignContent="center">
                        <FlexView vAlignContent="center">
                          <FlexView
                            className={css(styles.upload_files_area_style)}
                            onClick={() =>
                              this.props.toggleEditVideoDialog(UPLOAD_VIDEO_FIRST_TIME_MODE)
                            }
                          >
                            <Typography variant="body2" align="center">
                          ...
                          <OverlayTrigger
                            ...
                            overlay={
                              <Tooltip id={`tooltip-top`}>
                                Introduction video helps other members understand more about your
                                business.
                              </Tooltip>
                            }
                          >
                        ...
                        {!createBusinessProfile.videoToBeUploaded ? null : (
  ...
  shouldUploadButtonBeDisabled = () => {
    const { originalUser, createBusinessProfile } = this.props;

    // user is an issuer
    if (originalUser.type === DB_CONST.TYPE_ISSUER) {
      if (
        !createBusinessProfile.BusinessProfile.companyName ||
        createBusinessProfile.BusinessProfile.companyName.trim().length === 0 ||
