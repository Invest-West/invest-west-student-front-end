...
const mapDispatchToProps = (dispatch: ThunkDispatch<any, any, AnyAction>) => {
  return {
    setCopiedUser: (user: User | null, firstTimeSetCopiedUser?: true) =>
      dispatch(setCopiedUser(user, firstTimeSetCopiedUser)),
  };
};
...
class ProfileNew extends Component<ProfileProps, any> {
  ...
  setCopiedUserForTheFirstTime = () => {
    const { thirdViewUser, AuthenticationState, ProfileLocalState, setCopiedUser } = this.props;
