...
export const saveImage: ActionCreator<any> = () => {
  return async (dispatch: Dispatch, getState: () => AppState) => {
    const { copiedUser, EditImageDialogState } = getState().ProfileLocalState;
    ...
    try {
      ...
      return dispatch(
        openFeedbackSnackbar(FeedbackSnackbarTypes.Error, 'Could not save profile photo.')
      );
    }
  };
};
...
export const deleteImage: ActionCreator<any> = () => {
  return async (dispatch: Dispatch, getState: () => AppState) => {
    ...
    try {
      ...
      dispatch(deletingImageAction);
      return dispatch(
        openFeedbackSnackbar(FeedbackSnackbarTypes.Error, 'Could not delete profile photo.')
      );
    }
  };
};
