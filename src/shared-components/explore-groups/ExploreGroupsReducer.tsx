import {
  ...
  RemovingAccessRequestAction,
  SendingAccessRequestAction,
...
export const calculatePaginationIndices = (state: ExploreGroupsState) => {
  const startIndex = (state.currentPage - 1) * maxGroupsPerPage;
  let endIndex;
...
export const isSendingAccessRequest = (state: ExploreGroupsState, groupID: string) => {
  return (
    state.sendingAccessRequestToGroup !== undefined && state.sendingAccessRequestToGroup === groupID
  );
};
...
export const isRemovingAccessRequest = (state: ExploreGroupsState, groupID: string) => {
  return (
    state.removingAccessRequestFromGroup !== undefined &&
    state.removingAccessRequestFromGroup === groupID
  );
};
...
const exploreGroupsReducer = (state = initialState, action: ExploreGroupsAction) => {
  switch (action.type) {
    ...
    case ExploreGroupsEvents.CompleteFetchingGroups:
      const completeFetchingGroupsAction: CompleteFetchingGroupsAction =
        action as CompleteFetchingGroupsAction;
      return {
        ...state,
        groups: [...completeFetchingGroupsAction.groups],
        accessRequestsInstances:
          completeFetchingGroupsAction.accessRequestInstances !== undefined
        ...
        currentPage: 1,
        error:
          completeFetchingGroupsAction.error !== undefined
            ? { detail: completeFetchingGroupsAction.error }
            : state.error,
      };
    ...
    case ExploreGroupsEvents.FilterGroupsByGroupFilter:
      const filterGroupsByGroupFilterAction: FilterGroupsByGroupFilterAction =
        action as FilterGroupsByGroupFilterAction;
      return {
        ...state,
    ...
    case ExploreGroupsEvents.SendingAccessRequest:
      const sendingAccessRequestAction: SendingAccessRequestAction =
        action as SendingAccessRequestAction;
      return {
        ...state,
    ...
    case ExploreGroupsEvents.CompleteSendingAccessRequest:
      const completeSendingAccessRequestAction: CompleteSendingAccessRequestAction =
        action as CompleteSendingAccessRequestAction;
      return {
        ...state,
        sendingAccessRequestToGroup: undefined,
        accessRequestsInstances:
          completeSendingAccessRequestAction.updatedAccessRequestInstances !== undefined
            ? [...completeSendingAccessRequestAction.updatedAccessRequestInstances]
            : state.accessRequestsInstances,
        errorSendingAccessRequest:
          completeSendingAccessRequestAction.error !== undefined
            ? { detail: completeSendingAccessRequestAction.error }
            : state.errorSendingAccessRequest,
      };
    case ExploreGroupsEvents.RemovingAccessRequest:
      const removingAccessRequestAction: RemovingAccessRequestAction =
        action as RemovingAccessRequestAction;
      return {
        ...state,
    ...
    case ExploreGroupsEvents.CompleteRemovingAccessRequest:
      const completeRemovingAccessRequestAction: CompleteRemovingAccessRequestAction =
        action as CompleteRemovingAccessRequestAction;
      return {
        ...state,
        removingAccessRequestFromGroup: undefined,
        accessRequestsInstances:
          completeRemovingAccessRequestAction.updatedAccessRequestInstances !== undefined
            ? [...completeRemovingAccessRequestAction.updatedAccessRequestInstances]
            : state.accessRequestsInstances,
        errorRemovingAccessRequest:
          completeRemovingAccessRequestAction.error !== undefined
            ? { detail: completeRemovingAccessRequestAction.error }
            : state.errorRemovingAccessRequest,
      };
    default:
      return state;
  }
