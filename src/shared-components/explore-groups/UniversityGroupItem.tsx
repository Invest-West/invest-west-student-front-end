...
class UniversityGroupItem extends Component<
  UniversityGroupItemFullProps,
  UniversityGroupItemState
> {
  ...
  render() {
    const { university, AuthenticationState } = this.props;
    const { expanded } = this.state;
            ...
            <Box display="flex" alignItems="center" flexGrow={1}>
              ...
              <Box flexGrow={1}>
                <Box display="flex" alignItems="center" marginBottom={1}>
                  ...
                  />
                  {isUniversityMember && (
                    <Chip label="Member" size="small" color="secondary" style={{ marginLeft: 4 }} />
                  )}
                </Box>
            ...
            {courses.length === 0 ? (
              ...
              <Box>
                {courses.map((course, index) => {
                  ...
                  return (
                    <NavLink key={course.anid} to={courseRoute} style={{ textDecoration: 'none' }}>
                      <Box
                      ...
                      >
                        <Box display="flex" alignItems="center" justifyContent="space-between">
                          ...
                          <Box display="flex" alignItems="center" flex={1}>
                            <School
                              style={{ fontSize: 18, marginRight: 8, color: colors.primaryColor }}
                            />
                            <Typography
                              variant="subtitle1"
