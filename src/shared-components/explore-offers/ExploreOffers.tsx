          ...
          <Col xs={12} sm={12} md={6} lg={4}>
            <Box paddingY="6px">
              ...
              <Paper>
                ...
                >
                  <MenuItem
                    key={FetchProjectsPhaseOptions.Live}
                    value={FetchProjectsPhaseOptions.Live}
                  >
                    Live
                  </MenuItem>
                  <MenuItem
              ...
              <Paper>
                ...
                >
                  ...
                  {this.state.groups.map((group, index) => (
                    <MenuItem key={index} value={group.anid}>
                      {group.displayName}
                    </MenuItem>
                  ))}
                </Select>
            ...
            <Col xs={12} sm={12} md={12} lg={12}>
              {!hasOffersForCurrentFilters(ExploreOffersLocalState) ? (
                ...
                <Box>
                  ...
                  {!AuthenticationState.currentUser ? null : !isIssuer(
