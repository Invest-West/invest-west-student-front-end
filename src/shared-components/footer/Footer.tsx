...
class Footer extends Component<FooterProps, any> {
  render() {
    const { position, MediaQueryState } = this.props;
      ...
      >
        <Box display="flex" flexDirection="row" justifyContent="center">
          <CustomLink
            ...
            component="nav-link"
            childComponent={<Typography variant="body1">Terms of Use</Typography>}
          />
          ...
          <CustomLink
            ...
            component="nav-link"
            childComponent={<Typography variant="body1">Privacy Policy</Typography>}
          />
        </Box>
        ...
        <Box display="flex" flexDirection="row" alignItems="center" justifyContent="center">
          ...
          <Typography align="left" variant="body1">
            Powered by Student Showcase. <br /> Copyright © 2021 Student Showcase Ltd - All Rights
            Reserved.
          </Typography>
        </Box>
      </Box>
