...
class Footer extends Component {
  render() {
    const { MediaQueryState } = this.props;
    ...
    return (
      <Container
        ...
        style={{
          padding: 0,
          position:
            MediaQueryState.isMobile || !MediaQueryState.minHeightScreen ? 'relative' : 'fixed',
          marginTop: 200,
          bottom: 0,
        }}
      >
            ...
            <Row noGutters style={{ width: '100%' }}>
                ...
                >
                  ...
                  >
                    <Image
                      ...
                      style={{ width: 'auto', height: 45, margin: 8 }}
                    />
                  </FlexView>
                </a>
              </Col>
              <Col xs={12} sm={12} md={9} lg={10}>
                <FlexView width="100%" height="100%" vAlignContent="center">
                  <Typography variant="body1" align={MediaQueryState.isMobile ? 'center' : 'left'}>
