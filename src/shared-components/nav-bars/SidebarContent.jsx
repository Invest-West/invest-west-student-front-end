      ...
      <FlexView column width={240} height="100%">
        ...
        <FlexView column marginTop={10}>
          ...
          <List>
            ...
            {/** Offers table */}
            {!user ? null : user.type === DB_CONST.TYPE_ISSUER ? (
              <NavLink
            ...
            {/** Explore courses tab - Show different tabs based on user type */}
            {
              ...
              (user.superAdmin || user.superGroupAdmin) ? (
                <NavLink
                  to={{
                    pathname: dashboardProps.match.pathname,
                  ...
                  className={css(
                    sharedStyles.nav_link_white_text_hover_without_changing_text_color
                  )}
                >
                  <ListItem button onClick={() => toggleSidebar(false)}>
                    <ListItemIcon>
        ...
        <FlexView column height="100%" vAlignContent="bottom">
          <List>
            ...
            {!user ? null : user.type !== DB_CONST.TYPE_ADMIN ? (
              <NavLink
                to={{
                  pathname: dashboardProps.match.pathname,
