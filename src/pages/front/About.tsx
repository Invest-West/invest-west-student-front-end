        ...
        <section className="about-hero">
          <div className="about-hero-content">
            <div className="about-hero-text">
              ...
              <p>
                Here at Student Showcase we are passionate about giving students the best
                opportunity to show their best work, visually bringing to life there work.
              </p>
              <p>
                This allows you to view and interact with the real life projects that students from
                around the country have been working on and see if they are the right fit for you
                and you’re company.
              </p>
            </div>
