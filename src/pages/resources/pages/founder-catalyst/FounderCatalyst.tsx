              ...
              <Box padding="20px">
                    ...
                    <Col xs={12} sm={12} md={7} lg={8} xl={9}>
                      ...
                      >
                        ...
                        <Typography variant="body1" align="left">
                          ...
                          <br />
                          <br />
                          When raising investment for your business, the legal journey can be slow,
                          frustrating and expensive. When do you need a lawyer? How do you find a
                          good one? How can you afford them? This page aims to demystify some of the
                          process by showing you what documents you and your investors likely to
                          need as part of your fund-raising process.
                        </Typography>
                      </Box>
                    </Col>
                  </Row>
                ...
                <Box display="flex" flexDirection="column">
                  ...
                  <Box>
                    <ol>
                      ...
                      <br />
                      <li>
                        Student Showcase has negotiated a further 10% discount for our members.
                        Please sign up via the button below to receive your discount.
                        <br />
                        <br />
                        <CustomLink
                          ...
                          component="a"
                          childComponent={
                            <Box bgcolor="#31C2DE" color="white" clone>
                              <Button
                                variant="contained"
                  ...
                  <Box>
                    <ol>
                      ...
                      <br />
                      <li>
                        <b>Cap Table:</b> one for before investment and one for after. These provide
                        details of your current and future shareholders.
                      </li>
                      <br />
                      <li>
                ...
                <Box display="flex" flexDirection="column">
                  ...
                  <Typography variant="body1" align="justify">
                    FounderCatalyst was created by a team of successful entrepreneurs, angel
                    investors and lawyers to simplify and accelerate the early-stage investment
                    legal journey.
                    <br />
                    <br />
                    FounderCatalyst’s aim is to be the trusted legal platform of choice, simplifying
                    and managing the funding process, raising everyone’s chances of success.
                  </Typography>
                  <Box height="40px" />
