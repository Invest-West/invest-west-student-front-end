              ...
              <Box padding="20px">
                ...
                <Box display="flex" flexDirection="column">
                  ...
                  <Typography variant="body1" align="left" component="span">
                    <ol>
                      <li>
                        ...
                        <ol type="a">
                          <li>
                            <i>Patents</i> for technological innovations,
                          </li>
                          <li>
                            <i>Trademarks</i> for branding,
                          </li>
                          <li>
                            <i>Registered</i> Designs for the look and feel of a product,
                          </li>
                          <li>
                            <i>Copyright</i> for creative works such as instruction manuals or
                            software code.
                          </li>
                        </ol>
                      </li>
                      ...
                      <li>
                        ...
                        <ul>
                          <li>
                            There are differences in strength of registered vs unregistered rights,
                            as well as their costs and timescales. Its important to choose the right
                      ...
                      <li>
                        ...
                        <ul>
                          <li>
                            When discussing registered rights, always be clear whether you have made
                            an application for rights, or actually have granted rights.
                          </li>
                        </ul>
                      </li>
                      <br />
                      <li>
                        ...
                        <ul>
                          <li>
                            ...
                            design, does not mean that you automatically have the right to use it.
                          </li>
                          <li>
                            ...
                            proposed commercial activities will be impacted by pre-existing rights.
                          </li>
                        </ul>
                      </li>
                      <br />
                      <li>
                        ...
                        <ul>
                          <li>
                            {' '}
                            IP rights are only enforceable in the country or region they have been
                            granted.
                          </li>
                        </ul>
                      </li>
                  ...
                  <Typography variant="body1" align="left">
                    The UK IPO (Intellectual Property Office) provide funding for IP audits and
                    support for start-ups.{' '}
                    <b>
                      For more information on accessing IP audit funding in the South West, follow
                      this link
                    </b>
                    &nbsp;
                    <a
                ...
                <Box display="flex" flexDirection="column">
                  ...
                  <Typography variant="body1" align="justify">
                    ...
                    renowned for its excellence, earned by putting talented, energetic and
                    principled people at its heart.
                    <br />
                    <br />
                    Based in Europe but with global reach, we specialise in IP law and management.
                    Our clients benefit from an extraordinarily experienced and multi-faceted group
                    of IP experts. Our team includes patent, trade mark and design attorneys who
                    work on every technology and in all commercial fields.
                    <br />
                    <br />
