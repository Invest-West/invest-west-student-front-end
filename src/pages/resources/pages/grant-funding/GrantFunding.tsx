...
class GrantFunding extends Component<GrantFundingProps, any> {
  render() {
    const { MediaQueryState, toggleContactResourceDialog } = this.props;
              ...
              <Box padding="20px">
                ...
                <Box display="flex" flexDirection="column">
                  ...
                  <Box>
                    <Typography align="left" variant="body1">
                      ...
                      <ol>
                        <li>Capital/Business Growth grants and</li>
                        <li>R&D grants.</li>
                      </ol>
                      ...
                      <br />
                      <ul>
                        <li>No Debt - no costs or need to provide security</li>
                        <li>No Equity giveaway - ensuring you retain control</li>
                        <li>
                        ...
                        <li>
                          ...
                          supporting later access to investors.
                        </li>
                      </ul>
                    </Typography>
                  </Box>
                  ...
                  <Box>
                    <Typography align="left" variant="body1">
                      The main focus when applying for R&D grant funding should be on the outputs of
                      a defined project. There are typically four categories for assessing project
                      eligibility:
                      <br />
                      <ol>
                        <li>
                  ...
                  <Box>
                    <Typography align="left" variant="body1">
                      ...
                      waiting during the assessment window, progressing through due diligence and
                      then completing project kick off.
                    </Typography>
                  </Box>
                  ...
                  <Box>
                    <Typography align="left" variant="body1">
                      There are many different factors that will improve your chance of grant
                      funding success; a grant funding consultancy will know where to find suitable
                      funding, how to access it successfully and how to use it to best effect.
                      Granted let you focus on your business, saving you time while we write the
                      grant application for you.
                      <br />
                      <br />A good consultancy will have pertinent sector expertise, the ability to
                      upskill at a rapid pace in new technologies, and experience of working with
                ...
                <Box display="flex" flexDirection="column">
                  ...
                  <Typography variant="body1" align="justify">
                    Granted Consultancy are an in-house team of funding specialists with a
                    demonstrable 10-year track record of securing non-dilutive funding for
                    innovative companies, raising over £85m in grant funding and £2.5m in R&D Tax
                    Credits for clients.
                    <br />
                    <br />
                    Our full range of non-dilutive funding services (grant writing, project
                    management, training and R&D tax credit support) allow our clients to focus on
                    their business. Our experience covers the full lifespan of business maturities,
                    from start-ups to multinationals.
                    <br />
                    <br />
                    Granted Consultancy’s expertise spans a variety of cutting-edge technologies
                    with a focus on four key areas:
                    <ul>
                      <li>AI, Digital and Data</li>
                      <li>Clean-tech and Agri-tech</li>
                      <li>Health, Life Sciences and Education</li>
                      <li>Manufacturing, Mobility and Materials</li>
                    </ul>
                    <br />
                    <br />
                    The Granted team thrives on learning about new technologies, innovative business
                    models and the people behind them – then taking that information and translating
                    it into a language and format that funders can understand.
                  </Typography>
                  <Box height="40px" />
                  <Box>
                    <CustomLink
