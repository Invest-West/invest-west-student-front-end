              ...
              <Box padding="20px">
                ...
                <Box>
                  <Typography align="left" variant="body1">
                    Merixstudio’s key expertise is the delivery of high-quality and performant web
                    applications and cross-platform mobile apps. Based on the needs of our clients,
                    we can support them in end-to-end product development or seamlessly extend their
                ...
                <Box display="flex" flexDirection="column">
                  ...
                  <Box marginY="30px">
                    <Typography variant="body1" align="left">
                      Although similar at first glance, the three concepts differ considerably -
                      especially in terms of the purpose each of them serves. The choice of which
                      one to start with depends on many factors, including your current state of
                      knowledge or the budget you can spend on a given project.
                    </Typography>
                  </Box>
