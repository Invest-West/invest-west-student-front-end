import {
  DetailedPageCompleteSendingContactEmailAction,
  ResourcesAction,
  ResourcesEvents,
...
export const hasErrorSendingContactEmailInDetailedPage = (state: ResourcesState) => {
  return (
    !state.detailedPageSendingContactEmail &&
    state.detailedPageErrorSendingContactEmail !== undefined
  );
};
...
const resourcesReducer = (state = initialState, action: ResourcesAction) => {
  switch (action.type) {
    ...
    case ResourcesEvents.DetailedPageCompleteSendingContactEmail:
      const detailedPageCompleteSendingContactEmailAction: DetailedPageCompleteSendingContactEmailAction =
        action as DetailedPageCompleteSendingContactEmailAction;
      return {
        ...state,
        detailedPageContactDialogOpen: false,
        detailedPageSendingContactEmail: false,
        detailedPageErrorSendingContactEmail:
          detailedPageCompleteSendingContactEmailAction.error !== undefined
