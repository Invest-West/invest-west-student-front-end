...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    toggleSidebar: (checkSidebarDocked) =>
      dispatch(dashboardSidebarActions.toggleSidebar(checkSidebarDocked)),
...
class AdminDashboard extends Component {
  ...
  setDataForComponents = () => {
    ...
    if (!currentUser || (currentUser && currentUser.type !== DB_CONST.TYPE_ADMIN)) {
      return;
    }
  ...
  componentWillUnmount() {
    const { stopListeningForNotificationsChanged } = this.props;
  ...
  renderPageContent = () => {
    ...
    if (
      OffersTableLocalState.tableUser &&
      OffersTableLocalState.tableUser.id === AuthenticationState.currentUser.id
    ) {
    ...
    if (params.tab === HOME_TAB) {
      return (
        <Row noGutters style={{ marginBottom: 30 }}>
          ...
          {!(currentAdmin && currentAdmin.superAdmin) ? null : (
                ...
                <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                  <FlexView column>
                    ...
                    <Typography paragraph variant="body1" align="left">
                      Manage universities that have joined the system.
                    </Typography>
                  </FlexView>
                </AccordionSummary>
                <AccordionDetails>
                        ...
                        <OverlayTrigger
                          ...
                          overlay={
                            <Tooltip id={`tooltip-top`}>
                              {joinRequests.length} access requests are awaiting your review.
                            </Tooltip>
                          }
                        >
                          <Badge
                            badgeContent={!joinRequestsLoaded ? 0 : joinRequests.length}
                            color="error"
                            invisible={!joinRequestsLoaded ? true : joinRequests.length === 0}
                          />
                        </OverlayTrigger>
                      </FlexView>
                    </FlexView>
                ...
                <FlexView column>
                  <FlexView width="100%">
                    ...
                    <FlexView marginLeft={28} marginTop={8}>
                      ...
                      >
                        <Badge
                          badgeContent={projectsAwaitingDecision}
                          color="error"
            ...
            <Accordion className={css(styles.card_style)}>
              <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                <FlexView column>
                  ...
                  <Typography paragraph variant="body1" align="left">
                    Manage university admins. Only super university admin can add a new university
                    admin.
                  </Typography>
                </FlexView>
              </AccordionSummary>
              ...
              <Accordion className={css(styles.card_style)}>
                <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                  <FlexView column>
                    ...
                    <Typography paragraph variant="body1" align="left">
                      Review and action requests from group admins to add new admins to their
                      courses.
                    </Typography>
                  </FlexView>
                </AccordionSummary>
    ...
    if (params.tab === SETTINGS_TAB) {
      return currentAdmin && (currentAdmin.superAdmin || currentAdmin.superGroupAdmin) ? (
        <SuperAdminSettings />
      ) : (
        <GroupAdminSettings />
      );
  ...
  render() {
    ...
    return (
      <Sidebar
        sidebar={<SidebarContent dashboardProps={this.props} />}
        shadow={false}
        open={sidebarOpen}
