...
export default class EditCourseNameDialog extends Component<
  EditCourseNameDialogProps,
  EditCourseNameDialogState
> {
          ...
          <Box display="flex" flexDirection="column">
            ...
            {updating && (
              <Box display="flex" alignItems="center" marginTop="15px">
                ...
                <Box width="10px" />
                <Typography variant="body2">Updating course name...</Typography>
              </Box>
            )}
          </Box>
        </DialogContent>
