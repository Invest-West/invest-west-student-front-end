...
export const manageCoursesReducer = (state = initialState, action: ManageCoursesAction) => {
  switch (action.type) {
    ...
    case ManageCoursesEvents.AddNewCourseTextChanged:
      const addNewCourseTextChangedAction: AddNewCourseTextChangedAction =
        action as AddNewCourseTextChangedAction;
      return {
        ...state,
    ...
    case ManageCoursesEvents.CompletedSavingCoursesChanges:
      const completedSavingCoursesChanges: CompletedSavingCoursesChangesAction =
        action as CompletedSavingCoursesChangesAction;
      return {
        ...state,
        savingCourses: false,
        errorSavingCourses:
          completedSavingCoursesChanges.error !== undefined
            ? { detail: completedSavingCoursesChanges.error }
            : state.errorSavingCourses,
      };
    ...
    case ManageCoursesEvents.SetCourseStatistics:
      const setCourseStatisticsAction: SetCourseStatisticsAction =
        action as SetCourseStatisticsAction;
      return {
        ...state,
    ...
    case ManageCoursesEvents.UpdateCourseStatistic:
      const updateCourseStatisticAction: UpdateCourseStatisticAction =
        action as UpdateCourseStatisticAction;
