...
class InviteMultipleUsers extends Component<InviteMultipleUsersProps, InviteMultipleUsersState> {
  ...
  render() {
    ...
    const { dialogOpen, newEmail, newUserType, emailList, sending, emailError, selectedGroupId } =
      this.state;
    ...
    const allComplete =
      emailList.length > 0 &&
      emailList.every(
        (item) => item.status !== INVITE_STATUS_NONE && item.status !== INVITE_STATUS_SENDING
      );
                ...
                <Box>
                  ...
                  <FormControl fullWidth variant="outlined">
                    ...
                    >
                      <MenuItem value="">
                        <em>
                          {groupsLoaded ? 'Select a university...' : 'Loading universities...'}
                        </em>
                      </MenuItem>
                      ...
                      <TableBody>
                        {emailList.map((invite) => (
                          <TableRow key={invite.id}>
                            ...
                            <TableCell>
                              {invite.userType === DB_CONST.TYPE_ISSUER
                                ? 'Student'
                                : 'Project Viewer'}
                            </TableCell>
                            <TableCell>
                              ...
                              {invite.status === INVITE_STATUS_ERROR && (
                                <Chip label={invite.statusMessage} size="small" color="secondary" />
                              )}
                            </TableCell>
                            <TableCell>
                              <IconButton
