...
export const manageSectorsReducer = (state = initialState, action: ManageSectorsAction) => {
  switch (action.type) {
    ...
    case ManageSectorsEvents.AddNewSectorTextChanged:
      const addNewSectorTextChangedAction: AddNewSectorTextChangedAction =
        action as AddNewSectorTextChangedAction;
      return {
        ...state,
    ...
    case ManageSectorsEvents.CompletedSavingSectorsChanges:
      const completedSavingSectorsChanges: CompletedSavingSectorsChangesAction =
        action as CompletedSavingSectorsChangesAction;
      return {
        ...state,
        savingSectors: false,
        errorSavingSectors:
          completedSavingSectorsChanges.error !== undefined
            ? { detail: completedSavingSectorsChanges.error }
            : state.errorSavingSectors,
      };
    default:
      return state;
  }
