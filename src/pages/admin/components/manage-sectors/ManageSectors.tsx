    ...
    return (
      <Box>
        ...
        <Button
          ...
          variant="outlined"
          onClick={() => toggleAddNewSector()}
        >
          {!ManageSectorsLocalState.addingNewSector ? <AddIcon /> : <CloseIcon />}
        ...
        <Box display="flex" flexDirection="row" marginTop="20px">
          ...
          <Button
            ...
            variant="contained"
            color="primary"
            onClick={() => saveSectorsChanges()}
            disabled={isSavingSectorsChanges(ManageSectorsLocalState)}
          >
            {isSavingSectorsChanges(ManageSectorsLocalState) ? 'Saving ...' : 'Save changes'}
          </Button>
        </Box>
      </Box>
    );
