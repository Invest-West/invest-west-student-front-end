...
export const cancelSectorsChanges: ActionCreator<any> = () => {
  return (dispatch: Dispatch, getState: () => AppState) => {
    const systemAttributes: SystemAttributes | null =
      getState().ManageSystemAttributesState.systemAttributes;
    if (!systemAttributes) {
      return;
    }
...
export const saveSectorsChanges: ActionCreator<any> = () => {
  return async (dispatch: Dispatch, getState: () => AppState) => {
    const systemAttributes: SystemAttributes | null = JSON.parse(
      JSON.stringify(getState().ManageSystemAttributesState.systemAttributes)
    );
    if (!systemAttributes) {
      return;
    }
