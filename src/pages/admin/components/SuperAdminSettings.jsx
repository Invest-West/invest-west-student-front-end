...
const mapDispatchToProps = (dispatch) => {
  return {
    initializeClubAttributesEdited: () =>
      dispatch(superAdminSettingsActions.initializeClubAttributesEdited()),
    handleInputChanged: (event) => dispatch(superAdminSettingsActions.handleInputChanged(event)),
    handleExpandPledgeFAQPanel: (FAQ, isExpanded) =>
      dispatch(superAdminSettingsActions.handleExpandPledgeFAQPanel(FAQ, isExpanded)),
    ...
    toggleEditExpandedPledgeFAQ: () =>
      dispatch(superAdminSettingsActions.toggleEditExpandedPledgeFAQ()),
    ...
    handleQuillEditorChanged: (fieldName, content, delta, source, editor) =>
      dispatch(
        superAdminSettingsActions.handleQuillEditorChanged(
          fieldName,
          content,
          delta,
          source,
...
class SuperAdminSettings extends Component {
  ...
  componentDidMount() {
    const { initializeClubAttributesEdited } = this.props;
        ...
        <Row noGutters>
              ...
              <FormControl variant="standard">
                <FormControlLabel
                  ...
                  control={
                    <Checkbox
                      color="primary"
                      value={clubAttributesEdited.allowVideoUpload}
                      checked={clubAttributesEdited.allowVideoUpload}
                ...
                <FormHelperText>
                  ...
                  uploaded to the database. When turned off, the users cannot upload videos from
                  their machines, instead they can only upload a video URL.
                </FormHelperText>
              </FormControl>
            </FlexView>
          </Col>
          ...
          <Col xs={12} sm={12} md={12} lg={12}>
            ...
            <FlexView marginTop={20}>
              <TextField
                name="supportEmail"
                label="Support email"
                value={clubAttributesEdited.supportEmail}
                margin="normal"
                variant="outlined"
                fullWidth
                required
          ...
          <Col xs={12} sm={12} md={12} lg={12}>
            ...
            >
              ...
              {!addNewPledgeFAQ ? 'Add new FAQ' : 'Cancel adding new FAQ'}
            </Button>

            {!addNewPledgeFAQ ? null : (
              <FlexView column marginTop={15}>
                <TextField
                  name="addedPledgeQuestion"
                  label="Question"
                  value={addedPledgeQuestion}
                  margin="dense"
                  variant="outlined"
                  fullWidth
                  required
                ...
                />
                <TextField
                  name="addedPledgeAnswer"
                  label="Answer"
                  value={addedPledgeAnswer}
                  margin="dense"
                  variant="outlined"
                  fullWidth
                  required
              ...
              {!clubAttributesEdited[DB_CONST.PLEDGE_FAQS_CHILD]
                ...
                : clubAttributesEdited[DB_CONST.PLEDGE_FAQS_CHILD].map((FAQ) => (
                    <Accordion
                      ...
                      expanded={expandedPledgeFAQ && FAQ.id === expandedPledgeFAQ.id ? true : false}
                      onChange={this.handleExpandPledgeFAQPanel(FAQ)}
                    >
                      ...
                      <AccordionDetails>
                        <FlexView column width="100%">
                          ...
                          <FlexView marginTop={28}>
                            <Button
                              onClick={toggleEditExpandedPledgeFAQ}
                              variant="outlined"
                              color={
                                expandedPledgeFAQ &&
                                expandedPledgeFAQ.id === FAQ.id &&
                                editExpandedPledgeFAQ
                                  ? 'default'
                                  : 'primary'
                              }
                            ...
                            <Button
                              onClick={deleteExistingPledgeFAQ}
                              variant="outlined"
                              color="secondary"
                              className={css(sharedStyles.no_text_transform)}
                              style={{ marginLeft: 12 }}
                          ...
                          editExpandedPledgeFAQ ? (
                            <FlexView column width="100%" hAlignContent="right" marginTop={12}>
                              <TextField
                                name="editedPledgeQuestion"
                                label="Question"
                                value={editedPledgeQuestion}
                                margin="dense"
                                variant="outlined"
                                fullWidth
                                required
                                error={editedPledgeQuestion.trim().length === 0}
                                onChange={handleInputChanged}
                              />
                              <TextField
                                name="editedPledgeAnswer"
                                label="Answer"
                                value={editedPledgeAnswer}
                                margin="dense"
                                variant="outlined"
                                fullWidth
                                required
          ...
          <Col xs={12} sm={12} md={12} lg={12}>
            <FlexView column>
              ...
              <ReactQuill
                theme="snow"
                onChange={this.handleQuillEditorChanged('privacyPolicy')}
                modules={modules}
                value={
                  clubAttributesEdited.hasOwnProperty('privacyPolicy')
                    ? clubAttributesEdited.privacyPolicy
                    : { ops: [] }
                }
                style={{ marginTop: 20 }}
              />
              ...
              <FlexView marginTop={15} width="100%" hAlignContent="right">
                <Button
                  variant="contained"
                  color="primary"
                  onClick={() => saveEditedQuill('privacyPolicy')}
                  style={{ marginLeft: 12 }}
                >
                  Save
                </Button>
            ...
            <FlexView column>
              ...
              >
                <Button
                  ...
                  className={css(sharedStyles.no_text_transform)}
                >
                  View terms of use page
                </Button>
              </NavLink>

              <ReactQuill
                theme="snow"
                onChange={this.handleQuillEditorChanged('termsOfUse')}
                modules={modules}
                value={
                  clubAttributesEdited.hasOwnProperty('termsOfUse')
                    ? clubAttributesEdited.termsOfUse
                    : { ops: [] }
                }
                style={{ marginTop: 20 }}
              />
              ...
              <FlexView marginTop={15} width="100%" hAlignContent="right">
                <Button
                  variant="contained"
                  color="primary"
                  onClick={() => saveEditedQuill('termsOfUse')}
                  style={{ marginLeft: 12 }}
                >
                  Save
                </Button>
            ...
            <FlexView column>
              ...
              <FlexView column marginTop={30}>
                <Typography variant="body1" align="left">
                  <b>Risk warning footer</b>
                </Typography>
                <br />
                <Typography variant="body1" align="left" color="textSecondary">
                  Risk warning footer is used in the footer of the Explore Offers page and the
                  Pledge page.
                  <br />
                  <br />
                  As the course&apos;s name will be populated dynamically, therefore, anywhere in
                  the text that needs to use course&apos;s name, please replace it with{' '}
                  <b>
                    <u>%groupName%</u>
                  </b>
                  .
                  <br />
                  <br />
                  Also, this risk warning footer will need to have a URL that leads to the risk
                  warning page where the information will be further explained. Therefore, please
                  use the following format to express the URL:
                  <br />
                  <br />
                  <b>
                    <u>%URL%any text inside%URL%</u>
                  </b>
                  . For example:&nbsp;
                  <b>%URL%Please click here to see full risk warning.%URL%</b>. The URL doesn&apos;t
                  need to be put here manually, it will be done on the development side as long as
                  the format is correct.
                </Typography>
                <br />
                <TextField
                  variant="outlined"
                  name="riskWarningFooter"
                  placeholder="Edit risk warning footer"
              ...
              <FlexView column>
                ...
                >
                  <Button
                    ...
                    className={css(sharedStyles.no_text_transform)}
                  >
                    View risk warning page
                  </Button>
                </NavLink>

                <ReactQuill
                  theme="snow"
                  onChange={this.handleQuillEditorChanged('riskWarning')}
                  modules={modules}
                  value={
                    clubAttributesEdited.hasOwnProperty('riskWarning')
                      ? clubAttributesEdited.riskWarning
                      : { ops: [] }
                  }
                  style={{ marginTop: 20 }}
                />
                ...
                <FlexView marginTop={15} width="100%" hAlignContent="right">
                  <Button
                    variant="contained"
                    color="primary"
                    onClick={() => saveEditedQuill('riskWarning')}
                    style={{ marginLeft: 12 }}
                  >
                    Save
                  </Button>
            ...
            <FlexView column>
              ...
              >
                <Button
                  ...
                  className={css(sharedStyles.no_text_transform)}
                >
                  View create project terms and conditions page
                </Button>
              </NavLink>

              <ReactQuill
                theme="snow"
                onChange={this.handleQuillEditorChanged('createPitchTermsAndConditions')}
                modules={modules}
                value={
                  clubAttributesEdited.hasOwnProperty('createPitchTermsAndConditions')
                    ? clubAttributesEdited.createPitchTermsAndConditions
                    : { ops: [] }
                }
                style={{ marginTop: 20 }}
              />
              ...
              <FlexView marginTop={15} width="100%" hAlignContent="right">
                <Button
                  variant="contained"
                  color="primary"
                  onClick={() => saveEditedQuill('createPitchTermsAndConditions')}
                  style={{ marginLeft: 12 }}
                >
                  {' '}
                  Save
            ...
            <FlexView column>
              ...
              >
                <Button
                  ...
                  className={css(sharedStyles.no_text_transform)}
                >
                  View marketing preferences page
                </Button>
              </NavLink>

              <ReactQuill
                theme="snow"
                onChange={this.handleQuillEditorChanged('marketingPreferences')}
                modules={modules}
                value={
                  clubAttributesEdited.hasOwnProperty('marketingPreferences')
                    ? clubAttributesEdited.marketingPreferences
                    : { ops: [] }
                }
                style={{ marginTop: 20 }}
              />
              ...
              <FlexView marginTop={15} width="100%" hAlignContent="right">
                <Button
                  variant="contained"
                  color="primary"
                  onClick={() => saveEditedQuill('marketingPreferences')}
                  style={{ marginLeft: 12 }}
                >
                  Save
                </Button>
