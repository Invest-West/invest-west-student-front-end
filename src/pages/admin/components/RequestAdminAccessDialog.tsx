      ...
      return (
        ...
        >
          ...
          <Typography variant="body2" style={{ color: '#558b2f', marginTop: 8 }}>
            A signup invitation has been sent to {email}. They will receive an email with a link to
      ...
      return (
        ...
        >
          ...
          <Typography variant="body2" style={{ color: '#1976d2', marginTop: 8 }}>
            The user already has an account. They will receive an email to accept or decline the
            admin role.
          </Typography>
        </div>
      );
  ...
  return (
    <Dialog open={open} fullWidth maxWidth="sm" onClose={handleClose}>
      ...
      <DialogContent style={{ marginTop: 10, marginBottom: 20 }}>
        ...
        <Typography variant="body2" color="textSecondary" paragraph>
          If the user already has an account, they will receive an upgrade request. If they
          don&apos;t have an account, they will receive an invitation to sign up.
        </Typography>
