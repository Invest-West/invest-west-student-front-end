...
export default class EditUniversityNameDialog extends Component<
  EditUniversityNameDialogProps,
  EditUniversityNameDialogState
> {
          ...
          <Box display="flex" flexDirection="column">
            ...
            {updating && (
              <Box display="flex" alignItems="center" marginTop="15px">
                ...
                <Box width="10px" />
                <Typography variant="body2">Updating university name...</Typography>
              </Box>
            )}
          </Box>
        </DialogContent>
