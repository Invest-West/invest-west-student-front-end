...
> {
  ...
  handleAuthStateChange = () => {
    ...
    if (AuthenticationState.currentUser && requestId) {
      ...
      if (
        !CourseAdminInviteLocalState.validatingUpgrade &&
  ...
  render() {
    const { AuthenticationState, CourseAdminInviteLocalState } = this.props;
    const { requestId } = this.state;
    ...
    if (
      ...
      return this.renderError(
        'Invalid Request',
        CourseAdminInviteLocalState.upgradeRequestError || 'This request is invalid or has expired.'
      );
    }
    ...
    if (
      CourseAdminInviteLocalState.upgradeRequestValid &&
      CourseAdminInviteLocalState.upgradeRequestData
    ) {
              ...
              >
                <Box display="flex" justifyContent="center" marginBottom="20px">
                  {accepted ? (
                    ...
                    <CancelOutlinedIcon style={{ fontSize: 80, color: '#f44336' }} />
                  )}
                </Box>

                <Typography variant="h5" style={{ color: accepted ? '#4caf50' : '#f44336' }}>
            ...
            >
              ...
              >
                ...
                <Typography align="center" variant="body2" color="textSecondary">
                  ...
                  {requestData?.role === 'admin' ? 'an administrator' : 'a lecturer'}
                </Typography>
                ...
                {/* Request Details */}
                <Box bgcolor="#f5f5f5" padding="20px" borderRadius="8px" marginBottom="30px">
                  ...
                  <Typography variant="body1">
                    <strong>Role:</strong>{' '}
                    {requestData?.role === 'admin' ? 'Course Administrator' : 'Lecturer'}
                  </Typography>
                </Box>
