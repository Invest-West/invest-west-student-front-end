...
} from './ContactPitchOwnerDialogReducer';
        ...
        <DialogContent>
          <Box display="flex" flexDirection="column">
            <Typography
              variant="body1"
              align="left"
            >{`We will let the project owner know that you would like to find out more.`}</Typography>
            <Box height="20px" />
            <TextField
              label="Name"
              type="text"
            ...
            <Typography
              variant="body2"
              color="textSecondary"
            >{`This will be sent to: ${ContactPitchOwnerDialogLocalState.projectOwnerEmail}`}</Typography>
          </Box>
        </DialogContent>
        <DialogActions>
          {isSendingContactEmail(ContactPitchOwnerDialogLocalState) ? null : (
            <Button
