...
const contactPitchOwnerDialogReducer = (
  state = initialState,
  action: ContactPitchOwnerDialogAction
) => {
  switch (action.type) {
    case ContactPitchOwnerDialogEvents.ToggleContactDialog:
      const toggleContactDialogAction: ToggleContactDialogAction =
        action as ToggleContactDialogAction;
      return {
        ...state,
    ...
    case ContactPitchOwnerDialogEvents.CompleteSendingContactEmail:
      const completeSendingContactEmailFunction: CompleteSendingContactEmailAction =
        action as CompleteSendingContactEmailAction;
      return {
        ...state,
        contactDialogOpen: false,
        sendingContactEmail: false,
        errorSendingContactEmail:
          completeSendingContactEmailFunction.error !== undefined
    ...
    case ContactPitchOwnerDialogEvents.UpdateCompanyPosition:
      const updateCompanyPositionAction: UpdateCompanyPositionAction =
        action as UpdateCompanyPositionAction;
      return {
        ...state,
