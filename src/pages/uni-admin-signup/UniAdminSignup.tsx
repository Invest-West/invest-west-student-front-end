...
> {
  ...
  render() {
    const { UniAdminSignupLocalState } = this.props;
   ...
   */
  renderSignupForm() {
    const { MediaQueryState, UniAdminSignupLocalState, handleInputFieldChanged, createAccount } =
      this.props;
                ...
                {(this.state.isPasswordFocused || UniAdminSignupLocalState.password.length > 0) && (
                  <Box marginTop="8px">
                    <Typography
                      ...
                      style={{
                        color:
                          UniAdminSignupLocalState.password.length >= 8 ? '#4caf50' : '#f44336',
                      }}
                    >
                ...
                {UniAdminSignupLocalState.confirmedPassword.length > 0 && (
                  <Box marginTop="4px">
                    <Typography
                      ...
                      style={{
                        color:
                          UniAdminSignupLocalState.password ===
                          UniAdminSignupLocalState.confirmedPassword
                            ? '#4caf50'
                            : '#f44336',
                      }}
                    >
