...
class CreatePitchPageMain extends Component {
    ...
    if (projectID) {
      this.props.history.push({
        pathname: groupUserName
          ? ROUTES.CREATE_OFFER.replace(':groupUserName', groupUserName)
          : ROUTES.CREATE_OFFER_INVEST_WEST_SUPER,
   ...
   */
  loadData = () => {
    const { groupProperties, currentUser, selectProjectVisibility_setProject } = this.props;

    const { projectEditedLoaded, projectIDToBeLoadedAfterSavingFirstTime } = this.state;

    if (!currentUser || (currentUser && currentUser.type === DB_CONST.TYPE_INVESTOR)) {
    ...
    if (params.edit || projectIDToBeLoadedAfterSavingFirstTime) {
      // load the project
      realtimeDBUtils
        .loadAParticularProject(
          !params.edit ? projectIDToBeLoadedAfterSavingFirstTime : params.edit
        )
        .then((project) => {
          ...
          this.setState({
            ...
            createProject: {
              ...
              pitchExpiryDate: project.Pitch.hasOwnProperty('expiredDate')
                ...
                : null,
              financialRound: project.Pitch.hasOwnProperty('financialRound')
              ...
              detailsAboutEarlierFundraisingRounds: project.Pitch.hasOwnProperty(
                ...
                : '',
              pitchInvestorsCommitted: project.Pitch.hasOwnProperty('investorsCommitted')
  ...
  handleNextStepClick = () => {
    ...
    const { projectEdited, progressBeingSaved } = this.state;
                ...
                Pitch: {
                  ...
                  detailsAboutEarlierFundraisingRounds:
                    detailsAboutEarlierFundraisingRounds.trim().length === 0
                      ...
                      : detailsAboutEarlierFundraisingRounds,
                  investorsCommitted:
                    pitchInvestorsCommitted.trim().length === 0 ? null : pitchInvestorsCommitted,
                ...
                issuerID:
                  ...
                  params.admin && params.issuer
                    ...
                    : // in this case, it can be the issuer creating their own offer
                      ...
                      // main dashboard.
                      currentUser.id, // this can the id of the issuer or the group admin
                createdByGroupAdmin:
                  // a group admin is creating an offer on behalf of a known issuer
                  params.admin && params.issuer
      ...
      if (!utils.shouldAProjectBeEdited(currentUser, projectEdited)) {
        return (
          <FlexView column width="100%">
            <Typography variant="h4" color="error" align="center" style={{ marginTop: 50 }}>
              This investment opportunity can&apos;t be edited anymore.
            </Typography>
          </FlexView>
        );
      }
    ...
    switch (this.props.createProjectState.pitchPublishCheck) {
      ...
      case PITCH_PUBLISH_FALSE_MISSING_PITCH_PRESENTATION:
        ...
        // for other groups, pitch deck is still pitch deck
          ...
          msg =
            'Please upload a file or use our provided text editor to make your pitch presentation.';
        }
        break;
      default:
        return null;
              ...
              <FlexView column>
                ...
                <FlexView marginTop={10}>
                  <FormControl variant="standard" required fullWidth>
                    ...
                    />
                    <FormHelperText>
                      This will be circulated to studentss in and outside course.
                    </FormHelperText>
                  </FormControl>
                </FlexView>
                ...
                <FlexView marginTop={45}>
                  ...
                  >
                    <FormLabel style={{ marginBottom: 16 }}>
                      What financial round are you looking for?
                    </FormLabel>
                    <RadioGroup
                      name="financialRound"
                      value={createProjectState.financialRound}
                      onChange={this.onInputChanged}
                    >
                ...
                (!groupUserName &&
                  ...
                  <FlexView marginTop={45}>
                    <FormControl variant="standard" required fullWidth>
                      ...
                      />
                      <FormHelperText>
                        QIB won&apos;t be able to mention everyone. So, you can make it REALLY
                        exciting.
                      </FormHelperText>
                    </FormControl>
                  </FlexView>
              ...
              <FlexView column width="100%">
                <FlexView vAlignContent="center">
                  <Typography color="primary" variant="h6" align="left" style={{ marginRight: 15 }}>
                    Step 2: Upload pitch cover
                  </Typography>
                  <InfoOverlay
                    message="Pitch cover is an image or video that will appear on your pitch summary tile."
                    placement="right"
                  />
                </FlexView>
                    ...
                    {!createProjectState.pitchCoverTypeSelected ? null : createProjectState.pitchCoverTypeSelected ===
                      ...
                      <FlexView column marginTop={10}>
                        ...
                        <Typography
                          ...
                          style={{ marginTop: 11 }}
                        >
                          <u>Note:</u> Pitch cover must not exceed{' '}
                ...
                <FlexView column>
                  ...
                  <FlexView column marginTop={30} marginBottom={60}>
                    ...
                    <Typography
                      ...
                      style={{ marginTop: 11 }}
                    >
                      <u>Note:</u> Pitch deck must not exceed{' '}
                      {DB_CONST.MAX_VIDEO_OR_IMAGE_SIZE_IN_MB}MB. Files in formats .pdf, .doc,
                      .docx, .ppt, and .pptx are accepted only.
                    </Typography>
                ...
                <FormControl variant="standard" component="fieldset" style={{ marginTop: 30 }}>
                  <FormControlLabel
                    control={
                      <Checkbox
                        color="primary"
                        name="agreedToShareRaisePublicly"
                        value={createProjectState.agreedToShareRaisePublicly}
                        checked={createProjectState.agreedToShareRaisePublicly}
                        onChange={this.onCheckboxChanged}
                      />
                    }
                    label={
                      <Typography variant="body1" align="left">
                        If you&apos;re happy to share news of your raise publicly e.g. via Twitter,
                ...
                <FormControl variant="standard" component="fieldset">
                  <FormControlLabel
                    control={
                      <Checkbox
                        color="primary"
                        name="agreedToReceiveLocalInvestmentInfo"
                        value={createProjectState.agreedToReceiveLocalInvestmentInfo}
                        checked={createProjectState.agreedToReceiveLocalInvestmentInfo}
                        onChange={this.onCheckboxChanged}
                      />
                    }
                    label={
                      <Typography variant="body1" align="left">
                        If you&apos;re happy to receive information about the local investment
                        ecosystem (max 8 times a year), please tick this box.
                      </Typography>
                    }
                  />
                </FormControl>
...
class UploadingDialog extends Component {
  ...
  renderUploadFileMode = () => {
    const { uploadFileMode, params, projectEdited, currentUser } = this.props;

    switch (uploadFileMode) {
      case UPLOAD_PITCH_COVER_MODE:
        return (
          <Typography variant="body2" color="textSecondary" align="left">
            Uploading pitch cover
          </Typography>
        );
      case UPLOAD_PITCH_SUPPORTING_DOCUMENTS_MODE:
        return (
          <Typography variant="body2" color="textSecondary" align="left">
            Uploading pitch supporting documents
          </Typography>
        );
      case UPLOAD_PITCH_PRESENTATION_DOCUMENT_MODE:
        return (
          <Typography variant="body2" color="textSecondary" align="left">
            {' '}
            Uploading pitch presentation document
          </Typography>
        );
