...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    editUserProfile_setOriginalUserAndEditedUser: (user) =>
      dispatch(editUserActions.setOriginalUserAndEditedUser(user)),
    editUserProfile_startOriginalUserChangedListener: () =>
      dispatch(editUserActions.startOriginalUserChangedListener()),
...
class ProfilePageEditable extends Component {
  ...
  loadData = () => {
    ...
    const { editUserProfile_startOriginalUserChangedListener } = this.props;

    const { userToBeEdited, userToBeEditedLoaded, loadingUserToBeEdited } = this.state;
  ...
  render() {
    ...
    const { userToBeEdited, userToBeEditedLoaded } = this.state;
    ...
    if (authenticating || !adminLoaded || !userToBeEditedLoaded) {
      return (
        <FlexView marginTop={30} hAlignContent="center">
          <HashLoader
