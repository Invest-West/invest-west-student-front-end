...
class ProfilePageViewOnly extends Component {
    ...
    if (
      ...
      realtimeDBUtils
        .getInvitedUserBasedOnIDOrEmail(
          userToBeViewedID,
          realtimeDBUtils.GET_INVITED_USER_BASED_ON_OFFICIAL_ID
        )
        .then((invitedUser) => {
          this.setState({
              ...
              <Row noGutters>
                ...
                >
                  <FlexView width="100%" hAlignContent="center" vAlignContent="center">
                    ...
                    (userToBeViewed.profilePicture &&
                      userToBeViewed.profilePicture.findIndex(
                        (pictureItem) => !pictureItem.hasOwnProperty('removed')
                      ) === -1) ? (
                      <LetterAvatar
                        firstName={userToBeViewed.firstName}
                        lastName={userToBeViewed.lastName}
                        width={150}
                        height={150}
                        textVariant="h4"
                      />
                      ...
                      <FlexView width={156} height={156}>
                        <Image
                          ...
                          style={{ width: '100%', maxHeight: 156, objectFit: 'contain' }}
                        />
                      </FlexView>
                    )}
                  </FlexView>
                  ...
                  >
                    ...
                    <FlexView column marginTop={18} hAlignContent="center">
                      <Typography
                        align="center"
                        variant="body1"
                      >{`Email: ${userToBeViewed.email}`}</Typography>
                      {userToBeViewed.hasOwnProperty('linkedin') &&
                      userToBeViewed.linkedin.trim().length > 0 ? (
                ...
                <FlexView column>
                  ...
                  >
                    <Typography align="center" variant="body1">
                      University profile has not been uploaded.
                    </Typography>
                  </FlexView>
                </FlexView>
              ) : (
                <FlexView column>
                  ...
                  <FlexView column marginTop={15} marginLeft={15} marginRight={15}>
                    ...
                    <Typography variant="subtitle1" align="left">
                      Course Website:&nbsp;&nbsp;
                      <a
                        href={userToBeViewed.BusinessProfile.companyWebsite}
                    ...
                    <FlexView column>
                      ...
                      >
                        ...
                        (userToBeViewed.BusinessProfile.video &&
                          userToBeViewed.BusinessProfile.video.findIndex(
                            (video) => !video.hasOwnProperty('removed')
                          ) === -1) ? (
  ...
  renderUserStatus = (invitedUser) => {
    ...
    return (
      <Typography align="center" variant="subtitle1" color={statusMessage.color}>
        {statusMessage.msg}
      </Typography>
    );
  };
