...
const mapDispatchToProps = (dispatch: ThunkDispatch<any, any, AnyAction>) => {
  return {
    ...
    handleInputFieldChanged: (event: React.ChangeEvent<HTMLInputElement>) =>
...
class SignUpNewClass extends Component<SignUpProps & SignUpRouterProps, SignUpLocalComponentState> {
  ...
  trySetCourseFromUrl = () => {
    const { handleInputFieldChanged, ManageGroupUrlState, SignUpLocalState } = this.props;
    ...
    if (courseFromUrl && ManageGroupUrlState.group?.settings?.availableCourses) {
      ...
      if (courseDisplayName) {
        console.log(
          '[SIGNUP] Auto-selecting course from URL:',
          courseFromUrl,
          '->',
          courseDisplayName
        );
