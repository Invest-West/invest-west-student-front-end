...
class Signin extends Component {
   ...
   */
  renderAuthStatus = () => {
    const { groupProperties, authenticating, authStatus } = this.props;

    if (this.state.resetPassword.resetEmailSent) {
      return (
        <FlexView width="100%" className={css(styles.reset_email_sent)} marginBottom={20}>
      ...
      if (authenticating) {
        ...
        return (
          <FlexView className={css(styles.auth_error)} marginBottom={20}>
            <Typography variant="body2" align="left">
              {errorMsg}
            </Typography>
          </FlexView>
  ...
  render() {
    const { groupProperties, groupPropertiesLoaded, shouldLoadOtherData } = this.props;
...
class ResetPasswordDialog extends Component {
  ...
  renderReset = () => {
    const { groupProperties, resetChecking, resetError } = this.props;
    if (resetChecking) {
      return (
      ...
      if (resetError) {
        return (
          <FlexView
            ...
            marginBottom={30}
          >
            <Typography variant="body1" className={css(styles.reset_email_error_text)}>
        ...
        <FlexView column hAlignContent="center">
          <FlexView column marginRight={60} marginLeft={60}>
            <Typography variant="body1" align="center" paragraph>
              Please provide the email address you used when you signed up for your Student Showcase
              account.
            </Typography>
            <Typography variant="body1" align="center" paragraph>
