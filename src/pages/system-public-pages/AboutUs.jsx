        ...
        <Row noGutters style={{ padding: 10 }}>
          ...
          >
            ...
            <Typography paragraph variant="h6" align="center" style={{ marginTop: 35 }}>
              Student Showcase brings together students and founders to help grow the business
              community in the South West of England. Student Showcase requires a fully managed end
              to end technology platform that will facilitate the efficient and effective, low cost
              registration of participants, administration of projects, and communication of club
              members.
            </Typography>
          </Col>
            ...
            <Row>
              <Col xs={12} md={{ span: 2, offset: 2 }}>
                <FlexView column hAlignContent="center">
                  <Image
                    src={require('../../img/investors.jpg').default}
                    width="215"
                    height="215"
                  />
                  ...
                  <Divider
                    style={{ width: 80, marginBottom: 10, backgroundColor: colors.gray_300 }}
                  />
                  <Typography paragraph variant="body1" align="center" color="textSecondary">
                    Gain access to unique early stage businesses from across the South West. Ask us
                    about;
                  </Typography>
                  ...
                  <Typography paragraph variant="body1" align="center" color="textSecondary">
                    As local experts in the start up and scale up networks, we collate the best
                    opportunities so you can meet the right businesses for you.
                  </Typography>
                </FlexView>
              </Col>
              <Col xs={12} md={{ span: 2, offset: 1 }}>
                <FlexView column hAlignContent="center">
                  <Image
                    src={require('../../img/businesses.jpg').default}
                    width="215"
                    height="215"
                  />
                  <Typography variant="h6" style={{ marginTop: 10, marginBottom: 10 }}>
                  ...
                  />
                  <Typography paragraph variant="body1" align="center" color="textSecondary">
                    Use the Student Showcase platform to communicate with a huge pool of potential
                    investors that already have an interest in working with businesses in the South
                    West.
                  </Typography>
                  <Typography paragraph variant="body1" align="center" color="textSecondary">
                    Ask us about;
              ...
              <Col xs={12} md={{ span: 2, offset: 1 }}>
                <FlexView column hAlignContent="center">
                  ...
                  />
                  <Typography paragraph variant="body1" align="center" color="textSecondary">
                    The South West of England has a unique and vibrant entrepeunerial business
                    community. It thrives on innovation, style and an commitment to social
                    inclusion. As local experts we connect likeminded investors and businesses.
                  </Typography>
                </FlexView>
              </Col>
            </Row>
                ...
                <Col key={index} md={index === 0 ? { span: 2, offset: 1 } : { span: 2 }}>
                  <FlexView column hAlignContent="center">
                    <Image
                      ...
                      thumbnail
                      roundedCircle
                      style={{ marginBottom: 10, width: 150, height: 150, objectFit: 'cover' }}
                    />
