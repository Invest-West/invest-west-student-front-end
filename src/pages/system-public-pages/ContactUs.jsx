...
class ContactUs extends Component {
  ...
  onSubmitClick = (event) => {
    ...
    const { name, companyName, companyPosition, companyEmail, message } = this.state;
    ...
    const groupID = groupProperties ? groupProperties.anid : 'InvestWestSupport';
    ...
    emailUtils
      ...
      .then(() => {
        ...
        setFeedbackSnackbarContent('Your email has been successfully sent.', 'primary', 'bottom');
          ...
          .then((enquiryID) => {
            ...
            if (user) {
              realtimeDBUtils.trackActivity({
                ...
                activitySummary: realtimeDBUtils.ACTIVITY_SUMMARY_TEMPLATE_MADE_AN_ENQUIRY.replace(
                  '%group%',
  ...
  render() {
    ...
    const { name, companyName, companyPosition, companyEmail, message, submitClick, sending } =
      this.state;
            ...
            <form onSubmit={this.onSubmitClick}>
              <FlexView column marginTop={40}>
                ...
                <FlexView width="100%" marginTop={25}>
                  ...
                  >
                    <FormLabel>{isIssuer ? 'University Name' : 'Company Name'}</FormLabel>
                    <TextField
                      value={companyName}
                      name="companyName"
                      variant="outlined"
                ...
                <FlexView width="100%" marginTop={25}>
                  ...
                  >
                    <FormLabel>{isIssuer ? 'University Email' : 'Company Email'}</FormLabel>
                    <TextField
                      value={companyEmail}
                      name="companyEmail"
                      variant="outlined"
              ...
              <FlexView width="100%" marginTop={25}>
                ...
                >
                  ...
                  />
                  <FormHelperText>
                    Please enter the details of your request. A member of our support team will
