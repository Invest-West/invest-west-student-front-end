          ...
          <Row noGutters>
            <Col xs={12} sm={12} md={12} lg={12}>
              ...
              <Row noGutters>
                ...
                >
                  {!clubAttributes.riskWarning ? null : (
                    <FlexView
                      column
                      dangerouslySetInnerHTML={{
                        __html: utils.convertQuillDeltaToHTML(clubAttributes.riskWarning.ops),
                      }}
                      marginTop={35}
                    />
                  )}
...
export default connect(mapStateToProps)(RiskWarningPage);
