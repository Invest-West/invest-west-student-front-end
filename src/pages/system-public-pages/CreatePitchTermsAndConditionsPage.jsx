...
class CreatePitchTermsAndConditionsPage extends Component {
  ...
  render() {
    const { clubAttributes, clubAttributesLoaded } = this.state;
            ...
            <Col xs={12} sm={12} md={12} lg={12}>
              <Row noGutters style={{ backgroundColor: colors.gray_100 }}>
                <Col
                  ...
                  md={12}
                  lg={{ span: 8, offset: 2 }}
                  style={{ paddingTop: 30, paddingBottom: 30, paddingLeft: 12, paddingRight: 12 }}
                >
              ...
              <Row noGutters>
                ...
                >
                  {!clubAttributes.createPitchTermsAndConditions ? null : (
                    <FlexView
                      column
                      dangerouslySetInnerHTML={{
                        __html: utils.convertQuillDeltaToHTML(
                          clubAttributes.createPitchTermsAndConditions.ops
                        ),
                      }}
                      marginTop={35}
                    />
...
export default connect(mapStateToProps)(CreatePitchTermsAndConditionsPage);
